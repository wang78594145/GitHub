...
public abstract class Interpreter {
  ...
  /**
   * Optionally implement the canceling routine to abort interpret() method 可选的实现 程序 来中止解释器
   */
  @ZeppelinApi
  ...
  /**
   * Get completion （完成） list based on cursor position.（光标位置）
   * By implementing this method, it enables auto-completion.
   *
   * @param buf statements 语句
   * @param cursor cursor position in statements 语句的里的位置
  ...
  /**
   * Interpreter can implements it's own scheduler by overriding this method. 重载这个方法
