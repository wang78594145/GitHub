 ...
 *
 * Remember, list of interpreters are dedicated //专注的 to a session. Session could be shared across user
 * or notes, so the sessionId could be user or noteId or their combination.//结合
 * So InterpreterGroup internally//本质的 manages map of [interpreterSessionKey(noteId, user, or
 * their combination), list of interpreters]
 *
 * A InterpreterGroup runs on interpreter process.
 * And unit of interpreter instantiate//预设的, restart, bind, unbind.
